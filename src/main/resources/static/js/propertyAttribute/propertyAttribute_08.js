...
// 프로퍼티의 정의란 새로운 프로퍼티를 추가하면서 프로퍼티 어프리뷰트를 명시적으로 정의하거나, 기존의 프로퍼티의 프로퍼티 어프리뷰트를 재정의하는 것을 말한다.
// Object.defineProperty Method 를 사용하면 property attribute 를 정의할 수 있고
// 인수로는 객체의 참조, 데이터 프로퍼티의 키인 문자열, 프로퍼티 디스크립터를 객체 를 전달한다.
...
// firstName {value: "kyuSang", writable: true, enumerable: true, configurable: true}

// 디스크립터 객체의 프로퍼티를 누락시키면 undefined, false 가 기본값이다.
descriptor = Object.getOwnPropertyDescriptor(person, 'lastName');
console.log('lastName', descriptor);
// lastName {value: "Hwang", writable: false, enumerable: false, configurable: false}
